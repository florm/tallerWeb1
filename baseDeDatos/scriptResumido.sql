...
insert into Socio(apellido, dni, domicilioCalle, domicilioDepto, domicilioNumero, mail, nombre, pais, telefono, ciudad_id, pase_id, provincia_id, sucursal_id, usuario_id)
values('Lopez', '40345678','suipacha',null,'300', 'jlopez@gmail.com', 'Julieta', 'Argentina','1593457123', null, null, 2, 2, null);
...
insert into sucursalactividad (cupo, dia, horaDesde, horaHasta, actividad_id, sucursal_id)
values (5,null,null,null,1,1);
insert into sucursalactividad (cupo, dia, horaDesde, horaHasta, actividad_id, sucursal_id)
values (2,null,null,null,2,1);
insert into sucursalactividad (cupo, dia, horaDesde, horaHasta, actividad_id, sucursal_id)
values (10,null,null,null,3,1);
insert into sucursalactividad (cupo, dia, horaDesde, horaHasta, actividad_id, sucursal_id)
