...
//PRUEBA PARA TRAER SELECT - inscribiractividad e inscribiractividad2 son ejemplos
@RequestMapping(path = "/inscribiractividad", method = RequestMethod.GET) //Formulario clase auxiliar
