...
<body>
	...
	<div id="page">
		...
		<div class="container mt-5">
			<div class="row d-flex flex-column text-center m-5">
				<h2 class="text-uppercase">${sucursal.nombre}</h2>
			...
			<table id="pagos" class="table table-striped table-bordered"
				...
				<tbody>
					<c:forEach items="${listaPagos}" var="pago">
						<tr>
							<td>${pago.socio.nombre} ${pago.socio.apellido}</td>
							<td>${pago.fecha}</td>
							<td>$ ${pago.importe}</td>
			...
			<div class="row d-flex flex-column justify-content-center align-items-center m-5">
	...
	<script src="<c:url value="/js/pagos.js" />"></script>
