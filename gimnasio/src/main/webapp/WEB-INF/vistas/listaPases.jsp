...
<body>
 ...
 <div id="fh5co-pricing" style="background-image:url(images/fondo-gris.jpg);" data-stellar-background-ratio="0.5">
		<div class="container">
				...
				<div class="pricing">
					<div class="col-md-3 animate-box">
						...
						<c:forEach items="${listaPases}" var="lista">				
							...
							<div class="price"><sup class="currency">$</sup>${lista.precio}<small>mensual</small></div>
							<ul class="classes">
								<li class="color">Cantidad de beneficios:</li>
								<li>Cantidad de actividades:
								<c:choose>
							...
							<a href="#" class="btn btn-select-plan btn-sm">Seleccionar Pase</a>
							</c:forEach>
							</div>
						</div>
					</div>
		...
		<div class="container">
			<div class="row row-pb-md">
				<div class="col-md-4 fh5co-widget">
					...
					<p>La mayor cadena de gimnasios ubicada en Buenos Aires, que te permite dedicarle más tiempo a tu entrenamiento y a tu salud. Contamos con más de 20 sucursales para estar más cerca tuyo y que disfrutes de cada entrenamiento en un clima motivador y distendido.</p>
					<p><a class="btn btn-primary" href="#">Registrarme</a></p>
				</div>
				<div class="col-md-8">
					<h3>Clases</h3>
